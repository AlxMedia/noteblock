...
Kirki::add_field( 'noteblock_theme', array(
	...
	'section'		=> 'social',
	'tooltip'		=> esc_html__( 'Font Awesome names:', 'noteblock' ) . ' <a href="https://fontawesome.com/v5/search?s=brands" target="_blank"><strong>' . esc_html__( 'View All', 'noteblock' ) . ' </strong></a>',
	'row_label'		=> array(
		'type'	=> 'text',
	...
	'fields'		=> array(
		...
		'social-icon'	=> array(
			...
			'description'	=> esc_html__( 'Font Awesome icons. Ex: fa-facebook ', 'noteblock' ) . ' <a href="https://fontawesome.com/v5/search?s=brands" target="_blank"><strong>' . esc_html__( 'View All', 'noteblock' ) . ' </strong></a>',
			'default'		=> 'fa-',
		),
		'social-link'	=> array(
			'type'			=> 'link',
